...
import { LensProfileCreator } from '@/components/LensProfileCreator'

export default function Home() {
  const router = useRouter()
  const { isConnected } = useAccount()
  const { profile, needsNewProfile, signIn, loginLoading } = useLensAuth()
            ...
            >
              {loginLoading ? (
                <>
                  ...
                  <span className="ml-2">Connecting to Lens...</span>
                </>
              ) : (
